export function BackgroundEffect() {
  return (
    <>
      <div className="absolute top-0 z-[-2] h-full w-full bg-transparent bg-[radial-gradient(100%_50%_at_100%_70%,rgba(0,163,255,0.3)_0,rgba(0,163,255,0)_50%,rgba(0,163,255,0)_100%)]" />
